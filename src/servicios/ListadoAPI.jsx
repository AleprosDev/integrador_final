...
export const getListadoNoticias = async (criterioBusqueda, paginaActual) => {
    const respuesta = await fetch(`${Noticias_API}?q=${criterioBusqueda}&apikey=${API_KEY}&language=es&page=${paginaActual}Size=5&showFields=thumbnail&url&publishedAt&source`);
